...
export default function AboutSection() {
  ...
  const features = [
    { icon: Code,      title: "Clean Code",    description: t.about.features.cleanCode },
    { icon: Lightbulb, title: "Problem Solver", description: t.about.features.problemSolver },
    { icon: Users,     title: "Team Player",    description: t.about.features.teamPlayer },
    { icon: Zap,       title: "Fast Learner",   description: t.about.features.fastLearner },
  ]
  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-mono">{t.about.title}</h2>
        ...
        >
          <div className="bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-sm rounded-2xl p-8 border border-gray-600/30 shadow-2xl shadow-black/20 max-w-2xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-white font-mono">{t.about.education}</h3>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-gray-400">{t.about.graduated}</p>
            </div>
          </div>
        </motion.div>
